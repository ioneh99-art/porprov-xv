...
def main():
    ...
    for rec in records:
        ...
        is_auto = method in ("excel_exact", "excel_suggestion", "excel_suggestion_no_cabor", "direct_exact", "direct_exact_diff_cabor", "fuzzy_auto")
    ...
    auto_count = sum(stats.get(k, 0) for k in
                     ("excel_exact", "excel_suggestion", "excel_suggestion_no_cabor", "direct_exact", "direct_exact_diff_cabor", "fuzzy_auto"))
