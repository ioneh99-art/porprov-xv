  ...
  return (
    <>
      <button onClick={() => setOpen(true)}
        className="fixed top-4 right-6 z-[150] flex items-center gap-2 px-4 py-2 rounded-full font-semibold text-sm text-white shadow-lg hover:shadow-purple-500/30 transition-all hover:scale-105"
