'use client'
// src/app/operator/dayung/performance/page.tsx — PREMIUM (placeholder)
// Konsep mengikuti KONIDA Kab. Bandung, scope atlet Dayung. Isi konten menyusul.

export default function DayungPremium_Performance() {
  return (
    <div className="text-slate-200 py-20 text-center">
      ...
      <h1 className="text-2xl font-black text-white mb-2">Performance</h1>
