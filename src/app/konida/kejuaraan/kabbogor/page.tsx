'use client'
// src/app/konida/kejuaraan/kabbogor/page.tsx — v3
...
const LEVEL_CFG: Record<string,{color:string;label:string}> = {
  ...
  'Provinsi':      { color:'#10b981', label:'🏛 Provinsi' },
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-[11px] font-mono mt-0.5" style={{ color:'rgba(255,255,255,0.35)' }}>
                {kpi.totalRecords} records · {kpi.atletDenganRekam} atlet · Kab. Bogor
              </p>
            </div>
          </div>
            ...
            <div className="relative flex items-start gap-3 flex-wrap">
              ...
              <div className="flex-1 min-w-[200px]">
                ...
                <p className="text-[11px] text-amber-200/80 leading-relaxed">
                  Halaman ini berisi <strong>{kpi.totalDemo} data demo</strong> dari {kpi.atletDenganRekam} atlet top performer Kab. Bogor (mix event PORPROV XIV, PON XX, KEJURNAS, Pra-PORPROV). Admin dapat input data real via tabel <code className="px-1 rounded" style={{background:'rgba(251,191,36,0.1)'}}>riwayat_prestasi</code> di Supabase.
                  {kpi.totalReal > 0 && (
                    <> · Sudah ada <strong className="text-emerald-400">{kpi.totalReal} data REAL</strong>.</>
                  )}
                </p>
              </div>
            ...
            <div className="space-y-2.5">
              <div>
                <div className="flex items-center justify-between mb-1">
                  ...
                  <span className="text-base font-bold text-emerald-400">{kpi.totalReal}</span>
                </div>
                <Bar value={kpi.totalReal} max={kpi.totalRecords||1} color="#10b981" h={3}/>
              </div>
              <div>
                <div className="flex items-center justify-between mb-1">
                  ...
                  <div className="flex items-center justify-between mb-4 flex-wrap gap-2">
                    ...
                    <div className="flex items-center gap-1 px-1 py-1 rounded-lg"
                      ...
                      {([
                        ...
                        { k:'real', l:`✅ Real (${selectedHistoryRaw.filter(r=>!r.is_demo).length})`,    c:'#10b981' },
