'use client'
// src/app/konida/lappertandingan/kabbogor/page.tsx — v3
...
function generateDemoData(): Record<number, JurnalLaga[]> {
  return {
    ...
    4: [
      { id:'demo-4-1', waktu:'09:00', cabor:'Karate',      hasil:'FINAL Kumite -60kg Putra — Juara 1',                  medali:'Emas',         catatan:'🏆 Razandra raih emas pertama Karate Bogor', isDemo:true },
    ...
    <table>
      ...
      <tbody>
        ${jurnal.map((j,i)=>`<tr class="${j.isDemo?'demo':''}">
          ...
          <td>${j.isDemo?'<span class="demobadge">DEMO</span>':'<span style="color:#10b981;font-weight:bold">REAL</span>'}</td>
          <td>${j.catatan||'—'}</td>
        </tr>`).join('')}
      </tbody>
    </table>
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-[11px] font-mono mt-0.5" style={{color:'rgba(255,255,255,0.35)'}}>
                7-20 November 2026 · Kab. Bogor · PORPROV XV Jabar
              </p>
            </div>
          </div>
              ...
              <div className="flex-1 min-w-[200px]">
                ...
                <p className="text-[11px] text-amber-200/80 leading-relaxed">
                  ...
                  {totalCounters.realEntries > 0 && (
                    <> · Sudah ada <strong className="text-emerald-400">{totalCounters.realEntries} data REAL</strong> tercatat.</>
                  )}
                </p>
              </div>
              ...
              {totalCounters.realEntries > 0 && (
                <div className="mb-3">
                  <div className="flex items-center gap-1.5 mb-2">
                    ...
                    <span className="text-[9px] font-black uppercase tracking-widest text-emerald-400">REAL DATA</span>
                  </div>
                  ...
                  <div className="text-[9px] mt-1 text-center text-emerald-400/60">
                    ...
                    <div className="flex items-center justify-between mb-1">
                      ...
                      {hasData && (
                        <div className="flex gap-1">
                          {s.hasReal && <div className="w-1.5 h-1.5 rounded-full bg-emerald-400" title="Ada data real"/>}
                      ...
                      {filterMode !== 'all' && (
                        <span className="ml-1 px-1.5 py-0.5 rounded text-[9px] font-bold"
                          style={{
                            ...
                            color:      filterMode === 'real' ? '#10b981' : '#fbbf24',
                          }}>
                          filter: {filterMode}
                        </span>
                      )}
                ...
                <div className="flex items-center gap-2 flex-wrap">
                  ...
                  <div className="flex items-center gap-1 px-1 py-1 rounded-lg"
                    ...
                    {([
                      ...
                      { k:'real', l:`✅ Real (${jurnalRaw.filter(j=>!j.isDemo).length})`,             c:'#10b981' },
                            ...
                            <div className="rounded-xl p-4 group relative overflow-hidden"
                              ...
                              {j.catatan && (
                                <div className="relative pl-3 border-l-2"
                                  style={{borderColor: isDemo ? 'rgba(251,191,36,0.25)' : 'rgba(0,255,170,0.2)'}}>
