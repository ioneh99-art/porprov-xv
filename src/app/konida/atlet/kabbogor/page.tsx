'use client'
// src/app/konida/atlet/kabbogor/page.tsx — v2
// Fix: filter kontingen_id=1, tambah search nama, status Posted, dossier lengkap, export CSV
...
const isNonLokal = (kode: string) => kode && !kode.startsWith('3201')
...
export default function PageAtletKabBogor() {
  ...
  const handleExport = useCallback(()=>{
    ...
    a.href     = url
    a.download = `atlet_kabbogor_${new Date().toISOString().slice(0,10)}.csv`
    a.click()
  ...
  return (
    <div className="min-h-screen text-zinc-300 font-sans flex flex-col relative"
      ...
      <div className="fixed inset-0 pointer-events-none"
        style={{backgroundImage:'linear-gradient(rgba(0,255,170,0.025) 1px,transparent 1px),linear-gradient(90deg,rgba(0,255,170,0.025) 1px,transparent 1px)',backgroundSize:'24px 24px',zIndex:0}}/>
        ...
        <div className="max-w-[1600px] mx-auto flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-[11px] font-mono mt-0.5" style={{color:'rgba(255,255,255,0.35)'}}>
                Verifikasi Pendaftaran · Kontingen Kabupaten Bogor
              </p>
            </div>
          </div>
          <div className="flex items-center gap-3">
            ...
            <button onClick={()=>setShowExport(true)}
              ...
              style={{background:'rgba(0,255,170,0.12)',border:'1px solid rgba(0,255,170,0.3)',color:ACCENT}}>
      ...
      <main className="flex-1 p-6 max-w-[1600px] w-full mx-auto relative z-10 space-y-5">
        ...
        <div {...ani(0)} className="grid grid-cols-5 gap-4">
          ...
          {[
            {l:'Data Valid',       v:summary.verified, c:'#4ade80', sub:'Siap diterbitkan ID',   icon:CheckCircle },
            ...
            <div className="relative">
              ...
              <div className="grid grid-cols-3 gap-3">
                <div>
                  ...
                  <div className="text-3xl font-black text-emerald-400">{summary.sudahTes}</div>
                ...
                <div>
                  ...
                  <div className="text-3xl font-black" style={{color:summary.avgSkor>=70?'#10b981':summary.avgSkor>=50?'#fbbf24':'#f97316'}}>
                    {summary.avgSkor}%
                  </div>
                  <div className="text-[10px] text-zinc-500 mt-0.5">
          ...
          <div className="flex items-center gap-2 pl-3 ml-1 border-l border-white/5">
            ...
            <div className="flex gap-1">
              {([
                ...
                {k:'sudah', l:`✓ Tes (${summary.sudahTes})`, c:'#10b981'},
                ...
                return (
                  <div key={cabor.nama} className="rounded-xl border transition-all duration-200"
                    style={{
                      ...
                      background: isExpanded?'rgba(0,255,170,0.04)':'rgba(255,255,255,0.02)',
                    }}>
                    ...
                    <div className="p-4 flex items-center justify-between cursor-pointer select-none"
                      ...
                      <div className="flex items-center gap-3">
                        <div className="p-2 rounded-lg"
                          style={{background:cabor.pending>0?'rgba(251,191,36,0.1)':'rgba(0,255,170,0.1)',
      ...
      <div className={`fixed top-0 right-0 h-full w-full max-w-[480px] z-50 flex flex-col transform transition-transform duration-300 ease-in-out ${selectedAtlet?'translate-x-0':'translate-x-full'}`}
        style={{background:'#040f08',borderLeft:'1px solid rgba(0,255,170,0.15)'}}>
        {selectedAtlet && (
          <>
            {/* Dossier header */}
            <div className="flex items-center justify-between p-6 border-b" style={{borderColor:'rgba(0,255,170,0.1)',background:'rgba(0,255,170,0.04)'}}>
              <div>
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-5"
              ...
              <div className="flex gap-1 p-1 rounded-xl"
                ...
                <button
                  ...
                  style={{
                    ...
                    color:      modalTab==='fisik' ? '#10b981' : 'rgba(255,255,255,0.4)',
                  }}>
              ...
              {modalTab === 'fisik' && selectedAtlet.tes_fisik && (() => {
                ...
                const kategoriColor = KATEGORI_COLOR[tf.kesimpulan_kategori || ''] || '#10b981'
                  ...
                  <>
                    ...
                    {radarData.length > 2 && (
                      <div className="rounded-xl p-4"
                        ...
                        <div className="text-[10px] uppercase tracking-widest font-bold text-emerald-400 mb-3 flex items-center gap-2">
                        ...
                        <ResponsiveContainer width="100%" height={220}>
                          <RadarChart data={radarData}>
                            ...
                            <Radar dataKey="capaian" stroke="#10b981" fill="#10b981" fillOpacity={0.4}/>
                          </RadarChart>
                        </ResponsiveContainer>
                      </div>
                    )}
                      ...
                      <div className="rounded-xl p-3"
                        ...
                        {strongest.map((c,i) => (
                          <div key={i} className="flex justify-between text-[11px] mb-1">
                            ...
                            <span className="text-emerald-400 font-bold ml-2">{c.capaian_persen}%</span>
                          </div>
                        ))}
                      </div>
                      <div className="rounded-xl p-3"
                    ...
                    <button
                      onClick={()=>{
                        window.open(`/konida/Premiumreport/kabbogor/tes-fisik`, '_blank')
                      }}
                ...
                <div className="pt-4 border-t" style={{borderColor:'rgba(255,255,255,0.06)'}}>
                  ...
                  <div className="flex gap-3">
                    ...
                    <button onClick={()=>handleVerify(selectedAtlet.id,'Verified')}
                      ...
                      style={{background:'rgba(0,255,170,0.15)',border:`1px solid ${ACCENT}40`,color:ACCENT}}>
