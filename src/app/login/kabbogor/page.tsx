...
// Kab. Bogor Enterprise Login v2 (Layering Fixed & Solid Form)
// Background: peta wilayah Kab. Bogor (z-index fixed) + glass morphism form (Solid)
  ...
  return (
    <div className="min-h-screen flex overflow-hidden font-sans bg-[#020d06]">
      ...
      <div className="hidden lg:flex w-[58%] relative overflow-hidden flex-col p-10 justify-between">
        ...
        {/* opacity-50 membuat peta terlihat transparan, pointer-events-none menonaktifkan klik/drag */}
        ...
        {/* Dark Overlays agar teks putih tetap terbaca di atas peta */}
        ...
        {/* === LAYER 10: KONTEN UTAMA (Teks Tegar Beriman) === */}
      ...
      <div className="flex-1 flex items-center justify-center relative p-8 bg-gradient-to-br from-[#020d06] via-[#041209] to-[#020d06]">
        ...
        {/* Glassmorphism Card Wrapper (Ditebalkan / Lebih Solid) */}
